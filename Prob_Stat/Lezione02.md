...
$\mathcal{A_{*}} = \{ \emptyset, \{ 1 \}, \Omega \}$ invece non è una tribù, perché considerando $\{ 1 \}$, la seconda proprietà non è soddisfatta.
...
### Def Tribù generata da una famiglia di insiemi
